...
// andr-be 07/2023
/*
    modifies this fucking poker program to give it
    a goddmn low straight who cares any more? ffs!
*/
...
bool straight, flush, four, three, aces_low;
...
void print_result(void)
{
    if (straight && flush)  printf("Straight Flush!");
             ...
             aces_low)      printf("Straight, Aces Low!");
