// FLIGHT DEPARTURE ARRAY CALCULATOR
// andr-be 06/2023
/*
    this program modified so that the departure times are stored in an array, 
    with the arrival times stored in a separate array.
    the times are integers, representing minutes since midnight
    the program uses a loop to search the array of departure times for the closest
*/
